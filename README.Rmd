...
This is a presentation for the epiCurve function, which can be used to interpolate epidemiological curves assuming that the lying force of infection (FOI, i.e. the rate at which susceptible individuals acquire the infection) can be modelled through the density function of a normal distribution. There are two main assumptions beneath our analysis:
...
```{r curves_comparison, warning=FALSE}
selected_year=2016
selected_region="a"
